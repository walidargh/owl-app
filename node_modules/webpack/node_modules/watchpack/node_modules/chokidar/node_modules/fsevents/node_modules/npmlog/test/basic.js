...
// should be the same.
var signinfoEventsExpect = logPrefixEventsExpect
...
tap.test('basic', function (t) {
  ...
  log.on('log.info', signinfoEvents.push.bind(signinfoEvents))
  ...
  t.deepEqual(signinfoEvents, signinfoEventsExpect, 'signinfoEvents')
